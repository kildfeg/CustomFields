...
public class LimittedTextAreawL extends JComponent {

	private JLabel label;
	private LimittedTextArea limittedTextArea;
	...
	public LimittedTextAreawL(String text, int min, int max) {
		...
		limittedTextArea.setParent(this);
	...
	protected static ImageIcon createImageIcon(String path, String description) {
		java.net.URL imgURL = LimittedTextAreawL.class.getResource(path);
		if (imgURL != null) {
	...
	public boolean verify() {
		return limittedTextArea.verify();
	}
